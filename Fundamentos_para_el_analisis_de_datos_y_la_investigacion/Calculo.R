########### MATEMÁTICAS ESENCIALES PARA EL DATA SCIENCE ##############
...
#1. Calculo de la derivada x^2 y evaluación en distintos puntos

g=mosaicCalc::D(x^2 ~ x  )  # para escribir ~ en windows altGr+4 +espacio o Alt+126
...
#2. Valoración de funciones en un punto
...
#3. Calculo de la derivada y evaluación en dif. puntos
...
#4. Calculo de la derivada y evaluación en dif. puntos
...
#Ofrece el primer mín. encontrado

optimize(f, c(0,3), lower = 0, upper=3) 

#Ofrece el mín. global
