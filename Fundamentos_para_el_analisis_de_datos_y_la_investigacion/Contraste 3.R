...
datos3 <- read.csv("C:/Users/atorn/Desktop/Máster/Primer cuatrimestre/Fundamentos para el análisis de Datos y la Investigación/Casos prácticos/Contraste Hipotesis/pesos.csv")
...
#Ofrece el resumen estad?stico para los distintos grupos
...
res <- t.test(Peso ~ Grupo, data = datos3, paired = TRUE) #paired=TRUE; emparejados
res
